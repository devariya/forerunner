...
<body class="manifesto-template-page-manifesto page-template-default page">

<header id="header" class="site-header" role="banner" style="border-color: white; fill: white; background: #001733;">
