<?php
/**
 * The header for Portfolio Single Page
 *
...
<body class="project-template-default single single-project postid-164">

  <header id="header" class="site-header" role="banner" style="border-color: transparent; fill: white; background: none">
